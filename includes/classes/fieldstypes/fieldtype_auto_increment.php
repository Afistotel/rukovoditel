...
class fieldtype_auto_increment
{
	...
	function render($field,$obj,$params = array())
	{
		...
		{
			return '<p class="form-control-static">' . $cfg->get('prefix') . $obj['field_' . $field['id']]  . $cfg->get('suffix') . '</p>' . input_hidden_tag('fields[' . $field['id'] . ']', $obj['field_' . $field['id']], $attributes);
		}
		else 
		{
