...
class reports_sections
{
    ...
    function render()
    {
        ...
        $where_sql = !$this->is_common ? "and created_by='" . db_input($app_user['id']) . "'" : "";
        $sections_query = db_query("select * from app_reports_sections where reports_groups_id='" . db_input($this->reports_groups_id) . "' {$where_sql} order by sort_order");
